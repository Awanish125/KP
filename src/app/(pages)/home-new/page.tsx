/**
 * page.tsx — /home-new — experimental replica of the home page with the
 * scroll-morphing ParticleEntity backdrop (billboard → skyline → globe →
 * beacon → ring). Once approved, this layout replaces the main home page.
 *
 * Identical to (pages)/page.tsx except:
 *  - <ParticleEntity /> fixed canvas mounted at z-0
 *  - all page content wrapped in a relative z-1 layer so it paints above
 */
...
export default function HomeNew() {
  ...
  return (
    <div style={{ overflowX: "clip" }}>
      {/* Scroll-morphing brand particle backdrop — fixed, behind everything */}
      <ParticleEntity />
